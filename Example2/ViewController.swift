...
//        cell.configure(with: [models[(indexPath.section * itemsPerRow) + indexPath.row], models[(indexPath.section * itemsPerRow) + indexPath.row + 1]])
...
extension ViewController: MainViewControllerProtocol {
